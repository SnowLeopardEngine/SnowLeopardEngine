...
namespace SnowLeopardEngine
{
    ...
    void Animator::AddController(const Ref<AnimatorController>& controller)
    {
    ...
    void Animator::Blending(const Ref<AnimationClip>& sourceAnimationClip, const Ref<AnimationClip>& targetAnimationClip, int duration, float dt)
    {
        if (!sourceAnimationClip || !targetAnimationClip) return;
